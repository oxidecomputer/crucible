...
echo "========================================="
echo "Test the pantry for some basic actions"
echo "========================================="
...
echo "  dsc 1 is running (pid $dsc_pid, control 9998)"
...
echo "  dsc 1 has all 3 downstairs running"
...
echo "  dsc 2 is running (pid $dsc2_pid, control 9999)"
...
echo "  dsc 2 has all 3 downstairs running"
