...
impl UpstairsEncryptionContext {
    ...
    fn encrypt_in_place(&self, data: &mut [u8], sector_index: u128) {
        self.xts.encrypt_area(data, self.block_size, sector_index, get_tweak_default);
    }

    fn decrypt_in_place(&self, data: &mut [u8], sector_index: u128) {
        self.xts.decrypt_area(data, self.block_size, sector_index, get_tweak_default);
    }
}
